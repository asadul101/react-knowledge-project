...
const Bookmarks = ({ bookmarks, bookmarkTime }) => {
    return (
        <div className="md:w-1/3 bg-gray-100 p-6 mt-4  rounded-2xl">
            <div>
            ...
            <div className="border-2 border-red-400 rounded-xl p-5 bg-gray-500">
                ...
                {
                    bookmarks.map((bookmark, idx) => <Bookmark key={idx} bookmarkTime={bookmarkTime} bookmark={bookmark}></Bookmark>)
                }
            </div>
        </div>
    );
